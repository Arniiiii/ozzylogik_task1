...
namespace task1
{
  ...
  constexpr inline fmtlog::LogLevel verbosityLevelMap(task1::E_verbosityLevel level)
  {
    switch (level)
      {
        case task1::E_verbosityLevel::OFF:
          return fmtlog::LogLevel::OFF;
        case task1::E_verbosityLevel::ERR:
          return fmtlog::LogLevel::ERR;
        case task1::E_verbosityLevel::WRN:
          return fmtlog::LogLevel::WRN;
        case task1::E_verbosityLevel::INF:
          return fmtlog::LogLevel::INF;
        case task1::E_verbosityLevel::DBG:
